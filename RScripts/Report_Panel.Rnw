...
<<eval=TRUE, results="tex", echo=FALSE, warning=FALSE>>=
df <- data.frame(
  Kriterium = c("Librarygr\"oße", "Mean Coverage", "Basen > 50 Reads", "Basen > 150 Reads", "Exonische Basen > 50 Reads", "Exonische Basen > 150 Reads", "Insertgr\"oße (Standardabweichung)", "QC-Anteil", "Mean Qualit\"at pro Base"),
  Tumor = c(
  ...
  Mindestwert = c("50 Mio Reads", "1000 Reads", "90%", "90%", "90%", "90%", "100bp", "40-60%", 30)
)
