...
<<eval=TRUE, results="tex", echo=FALSE, warning=FALSE>>=
df <- data.frame(
  Kriterium = c("Librarygröße", "Mean Coverage", "Basen > 50 Reads", "Basen > 150 Reads", "Exonische Basen > 50 Reads", "Exonische Basen > 150 Reads", "Insertgröße (Standardabweichung)", "QC-Anteil", "Mean Qualität pro Base"),
  Tumor = c(
