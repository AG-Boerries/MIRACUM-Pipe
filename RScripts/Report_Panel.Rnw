...
<<eval=TRUE, results="tex", echo=FALSE, warning=FALSE>>=
df <- data.frame(
  Kriterium = c("Librarygr{\"o}{\ss}e", "Mean Coverage", "Basen > 50 Reads", "Basen > 150 Reads", "Exonische Basen > 50 Reads", "Exonische Basen > 150 Reads", "Insertgr{\"o}{\ss}e (Standardabweichung)", "QC-Anteil", "Mean Qualit{\"a}t pro Base"),
  Tumor = c(
