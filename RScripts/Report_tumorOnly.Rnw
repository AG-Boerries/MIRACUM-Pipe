...
<<eval=TRUE, results="tex", echo=FALSE, warning=FALSE>>=
df <- data.frame(
  Kriterium = c("Librarygr\"o{\ss}e", "Mean Coverage", "Basen > 8 Reads", "Basen > 40 Reads", "Exonische Basen > 8 Reads", "Exonische Basen > 40 Reads", "Insertgr\"o{\ss}e (Standardabweichung)", "QC-Anteil", "Mean Qualit\"at pro Base"),
  Tumor = c(
