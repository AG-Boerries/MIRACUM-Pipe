...
Chromosomes="/home/miracum/Genome/Homo_sapiens/UCSC/hg19/Sequence/Chromosomes"
ChromoLength="/home/miracum/Genome/Homo_sapiens/UCSC/hg19/Sequence/Chromosomes/hg19.len"
...
# ControlFREEC
freec="/home/miracum/FREEC-11.5/bin/freec"
gemMappabilityFile="/home/miracum/Genome/Homo_sapiens/MappabilityFile/out100m2_hg19.gem"
...
xx=${4};
InputPath=${homedata}/$xx/fastq ## change later !!!
...
/usr/bin/pdflatex -interaction=nonstopmode Report.tex
/usr/bin/pdflatex -interaction=nonstopmode Report.tex
